...
var Account = function () {
    ...
    var addMember = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var saveEdit = function () {
        ...
        setMembers(members.map(function (m) {
            return m.id === editId
                ? __assign(__assign({}, m), { name: editName.trim(), role: editRole.trim() }) : m;
        }));
        cancelEdit();
    };
    ...
    var deleteMember = function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fetch("/api/family-members/".concat(id), {
                            method: 'DELETE',
                            headers: {
                                Authorization: token || '',
                            },
    ...
    return (_jsxs(Container, { children: [_jsx("h2", { children: "Hantera familjemedlemmar" }), _jsxs("p", { children: ["L\u00E4gg till medlemmar i hush\u00E5ll ", userName] }), _jsxs(AddMemberSection, { children: [_jsx("input", { type: "text", placeholder: "Namn", value: newName, onChange: function (e) { return setNewName(e.target.value); } }), _jsxs("select", { value: newRole, onChange: function (e) { return setNewRole(e.target.value); }, children: [_jsx("option", { value: "", children: "V\u00E4lj roll" }), _jsx("option", { value: "vuxen", children: "Vuxen" }), _jsx("option", { value: "barn", children: "Barn" })] }), _jsx("button", { onClick: addMember, children: "L\u00E4gg till" })] }), _jsxs(List, { children: [members.length === 0 && _jsx("p", { children: "Inga familjemedlemmar tillagda \u00E4nnu." }), members.map(function (member) {
                        return editId === member.id ? (_jsxs(ListItem, { children: [_jsx("input", { type: "text", value: editName, onChange: function (event) { return setEditName(event.target.value); } }), _jsx("input", { type: "text", value: editRole, onChange: function (event) { return setEditRole(event.target.value); } }), _jsx("button", { onClick: saveEdit, children: "Spara" }), _jsx("button", { onClick: cancelEdit, children: "Avbryt" })] }, member.id)) : (_jsxs(ListItem, { children: [_jsxs("span", { children: [_jsx("strong", { children: member.name }), " - ", member.role] }), _jsxs(Buttons, { children: [_jsx("button", { onClick: function () { return startEditing(member); }, children: "Redigera" }), _jsx("button", { onClick: function () { return deleteMember(member.id); }, children: "Ta bort" })] })] }, member.id));
                    })] })] }));
};
