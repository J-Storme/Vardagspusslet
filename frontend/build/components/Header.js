...
function Header() {
    ...
    return (_jsxs(HeaderContainer, { children: [_jsxs(LogoContainer, { children: [_jsx("h1", { children: "Vardagspusslet" }), _jsx("img", { src: "/logo.png", alt: "logo" })] }), isLoggedIn && _jsxs(WelcomeText, { children: ["Hush\u00E5ll ", userName, "!"] })] }));
}
