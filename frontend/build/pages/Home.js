...
function Home() {
              ...
              case 2:
                ...
                allMembers = data
                  .flatMap(function (event) {
                    var _a;
                    return (_a = event.family_members) !== null && _a !== void 0
                      ? _a
                      : [];
                  })
  ...
  if (!token || !userId) {
    return _jsx('div', {
      children: 'Du m\u00E5ste vara inloggad f\u00F6r att se events.',
    });
  }
  return _jsxs(EventsContainer, {
    children: [
      _jsx('h1', { children: 'V\u00E4lkommen till Vardagspusslet!' }),
      _jsx('p', { children: 'Planera familjens vardag tillsammans.' }),
      _jsx(CalendarView, { events: events, familyMembers: familyMembers }),
      _jsx(Events, {
        token: token,
        userId: userId,
        events: events,
