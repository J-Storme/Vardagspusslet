...
function CalendarView(_a) {
  var events = _a.events,
    familyMembers = _a.familyMembers;
  ...
  return _jsxs('div', {
    children: [
      ...
      _jsxs(DailyEventList, {
        children: [
          _jsx('h3', { children: 'Dagens h\u00E4ndelser:' }),
          selectedDateEvents.length > 0
            ? selectedDateEvents.map(function (event) {
                var _a;
                var memberNames = (
                  (_a = event.family_member_ids) !== null && _a !== void 0
                    ? _a
                    : []
                )
                  .map(function (id) {
                ...
                return _jsxs(
                  EventItem,
                  { children: [event.title, ' \u2014 ', memberNames] },
                  event.id,
                );
              })
