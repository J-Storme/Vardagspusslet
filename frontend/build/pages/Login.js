...
function Login() {
  ...
  return _jsxs(LoginContainer, {
    children: [
      _jsx('h2', { children: 'Logga in' }),
      _jsx('input', {
        type: 'email',
        placeholder: 'E-post',
        value: email,
      ...
      _jsx('button', { onClick: handleLogin, children: 'Logga in' }),
      _jsxs('div', {
        children: [
          _jsx('p', { children: 'Har du inget konto?' }),
          _jsx('button', {
