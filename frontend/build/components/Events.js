...
function Events(_a) {
    ...
    return (_jsxs(EventsFormContainer, { children: [_jsx(Title, { children: "Aktiviteter" }), loading && _jsx("p", { children: "Laddar..." }), _jsxs(FormContainer, { children: [!isAddingEvent && (_jsx(SubmitButton, { onClick: /*För att öppna formuläret */ function () { return setIsAddingEvent(true); }, children: "L\u00E4gg till nytt event" })), isAddingEvent && (_jsxs(StyledForm, { onSubmit: handleSubmit, children: [_jsxs(FormGroup, { children: [_jsx("label", { children: "Titel:" }), _jsx("input", { type: "text", value: title, onChange: function (event) {
                      ...
                      och [0] tar första delen av arrayen som är datumet*/
                        new Date(event.event_date).toISOString().split('T')[0], _jsx("br", {}), 
