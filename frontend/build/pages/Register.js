...
function Register() {
  ...
  return _jsx(_Fragment, {
    children: _jsxs(RegisterContainer, {
      children: [
        _jsx('h2', {
          children: 'Registrera ett konto f\u00F6r hush\u00E5llet',
        }),
        _jsxs(LabelRow, {
          children: [
            _jsx('label', {
              htmlFor: 'name',
              children: 'Hush\u00E5llets namn:',
            }),
            _jsx('input', {
              type: 'text',
        ...
        _jsxs(LabelRow, {
          children: [
            _jsx('label', { htmlFor: 'email', children: 'E-post:' }),
            _jsx('input', {
              type: 'email',
              placeholder: 'E-post',
              value: email,
        ...
        _jsxs(LabelRow, {
          children: [
            _jsx('label', { htmlFor: 'password', children: 'L\u00F6senord:' }),
            _jsx('input', {
              type: 'password',
        ...
        _jsx(Button, { onClick: handleRegister, children: 'Registrera' }),
      ],
    }),
  });
}
...
// Styling
var RegisterContainer = styled.div(
  templateObject_1 ||
